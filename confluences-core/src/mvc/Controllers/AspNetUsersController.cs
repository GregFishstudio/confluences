...
namespace mvc.Controllers
{
    ...
    public class AspNetUsersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                streamTask = await client.GetStreamAsync(_configuration["URLAPI"] + "api/ApplicationUsers/");
            }
            catch (Exception e)
            {
                throw e;
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var streamTask = await client.GetStreamAsync(_configuration["URLAPI"] + "api/ApplicationUsers/" + id);
        ...
        public async Task<IActionResult> Edit(string id, [Bind("Id,AccessFailedCount,ConcurrencyStamp,Email,EmailConfirmed,LockoutEnabled,LockoutEnd,NormalizedEmail,NormalizedUserName,PasswordHash,PhoneNumber,PhoneNumberConfirmed,SecurityStamp,TwoFactorEnabled,UserName,Birthday,Firstname,LastName,GenderId, Pictures, WantsMoreHomeworks, Nationality, Language")] AspNetUser aspNetUser)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                HttpResponseMessage response = await client.PutAsync(_configuration["URLAPI"] + "api/ApplicationUsers/" + id, httpContent);
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            HttpResponseMessage result = await client.DeleteAsync(_configuration["URLAPI"] + "api/ApplicationUsers/" + id);
