...
namespace mvc.Controllers
{
    ...
    public class TheoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create(
            [Bind("TheoryId,TheoryDate,TheoryName,TheoryLink,TeacherId,HomeworkV2id,AudioLink,AudioLinkSecond,AudioLinkThird,VideoLink")] Theory theory, 
            ...
            [FromForm] IFormFile fileVideo)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (fileAudioSecond != null)
                {
                    ...
                    theory.AudioLinkSecond = await responseTheory.Content.ReadAsStringAsync();
                ...
                if (fileAudioThird != null)
                {
                    ...
                    theory.AudioLinkThird = await responseTheory.Content.ReadAsStringAsync();
