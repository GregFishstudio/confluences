...
namespace Api.Controllers
{
    ...
    public class HomeworkV2sController : ControllerBase
    {
        ...
        public HomeworkV2sController(ConfluencesDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<HomeworkV2>> GetHomeworkV2s(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutHomeworkV2s(int id, HomeworkV2 homeworkV2s)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<HomeworkV2>> PostHomeworkV2s(HomeworkV2 homeworkV2s)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<HomeworkV2>> DeleteHomeworkV2s(int id)
        {
