...
namespace Api.Controllers
{
    ...
    public class HomeworkV2studentExerciceAlonesController : ControllerBase
    {
        ...
        public HomeworkV2studentExerciceAlonesController(ConfluencesDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<HomeworkV2StudentExerciceAlone>>> GetHomeworkV2studentExerciceAlones()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<HomeworkV2StudentExerciceAlone>> GetHomeworkV2studentExerciceAlones(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutHomeworkV2studentExerciceAlones(int id, HomeworkV2StudentExerciceAlone homeworkV2studentExerciceAlones)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<HomeworkV2StudentExerciceAlone>> PostHomeworkV2studentExerciceAlones(HomeworkV2StudentExerciceAlone homeworkV2studentExerciceAlones)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<HomeworkV2StudentExerciceAlone>> DeleteHomeworkV2studentExerciceAlones(int id)
        {
            var homeworkV2studentExerciceAlones = await _context.HomeworkV2StudentExerciceAlones.FindAsync(id);
            if (homeworkV2studentExerciceAlones == null)
            {
