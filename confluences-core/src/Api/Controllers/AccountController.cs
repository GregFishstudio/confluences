...
namespace Api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(ConfluencesDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet()]
        public ActionResult<bool> CheckAccessToken()
        {
            return true;
        }
        ...
        [HttpGet()]
        public async Task<ActionResult<ApplicationUser>> GetApplicationUserStudent()
        {
            ApplicationUser user = null;
            string id = "";
        ...
        [HttpGet()]
        public async Task<ActionResult<ApplicationUser>> GetApplicationUserAppointments()
        {
            ApplicationUser user = null;
            string id = "";
        ...
        public async Task<ActionResult<string>> IGetIt()
        {
            ...
            ApplicationUser.HasSeenHelpVideo = true;
