...
namespace Api.Controllers
{
    ...
    public class SessionsController : ControllerBase
    {
        ...
        public SessionsController(ConfluencesDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Session>>> GetSessions()
        {
            return await _context.Sessions
                                        ...
                                        .OrderByDescending(s => s.DateStart.Year)
                                            .ThenByDescending(s => s.SessionNumberId)
                                            .ThenBy(s => s.SchoolClassRoom.SchoolClassRoomName)
                                        .ToListAsync();
        }
