...
namespace Api.Controllers
{
    ...
    public class TypeEntrepriseController : ControllerBase
    {
        ...
        public TypeEntrepriseController(ConfluencesDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TypeEntreprise>>> GetTypeEntreprises()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<TypeEntreprise>> GetTypeEntrepris(int id)
        {
            var typeEntrepris = await _context.TypeEntreprises
                .Include(t => t.Entreprise)
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTypeEntrepris(int id, TypeEntreprise typeEntrepris)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<TypeEntreprise>> PostTypeEntrepris(TypeEntreprise typeEntrepris)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<TypeEntreprise>> DeleteTypeEntrepris(int id)
        {
