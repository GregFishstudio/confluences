...
const typeSearchAssistanceOccurrence = ref({
  typeSearchAssistanceOccurrenceId: 0,
  description: null
})
...
async function submit() {
  ...
  store
    .dispatch(
      'typeJobSearchAssistanceOccurrence/createtypeSearchAssistanceOccurrence',
      typeSearchAssistanceOccurrence.value
    )
    .then(() => {
      ...
      <v-dialog v-model="dialog" max-width="520">
        ...
        <v-card rounded="lg" class="pa-2">
          ...
          <v-card-title class="d-flex align-center py-4">
            ...
            <span class="text-h6 font-weight-bold">Ajouter une occurrence ARE</span>
          </v-card-title>
          ...
          <v-card-text class="pt-6">
            <v-text-field
              v-model="typeSearchAssistanceOccurrence.description"
